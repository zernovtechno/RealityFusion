...
namespace Mediapipe.Unity.Sample.HandLandmarkDetection
{
  public class HandLandmarkDetectionConfig
  {
    ...
    public float MinHandDetectionConfidence { get; set; } = 0.85f;
    public float MinHandPresenceConfidence { get; set; } = 0.85f;
    public float MinTrackingConfidence { get; set; } = 0.85f;
